...
##############################################################################################################################
############## Dodge Error Bar PLOT - Hematologica Parameters ####################################################################################################
...
ggplot(data = df, aes(x = Treatment, y = Lipid.Derivatives)) +
  geom_tile(aes(fill = Content)) +
  #  scale_fill_gradient(low = "white", high = "red") +
  labs(x = "Treatment", y = "Lipid Derivatives", title = "Fatty Acid Profile")
...
ggp <- ggplot(data_melt, aes(Treatment, Lipid.Derivatives)) +                           # Create heatmap with ggplot2
